  ...
  render() {
    return (
      <div>
        ...
        <section className="display-current-weather d-flex flex-justify-between flex-auto">
          <h1 className="city" >{this.props.location}</h1>
          <p className="date">{this.props.weatherData.dataTime}</p>
        </section>
        <section className="display-temp-icon-container d-flex justify-content-center">
